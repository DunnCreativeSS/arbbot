...
require_once __DIR__ . '/../CCXTAdapter-hitbtc.php';

define( 'HITBTC_ID', 10 );

class HitbtcExchange extends \ccxt\hitbtc2 {

  use CCXTErrorHandler;

  public function nonce() {
    return generateNonce( HITBTC_ID );
  }
...
class Hitbtc extends CCXTAdapterhitbtc {

  public function __construct() {
    $extraOptions = array(
      'recvWindow' => 15 * 1000, // Increase recvWindow to 15 seconds.
    );
    parent::__construct( HITBTC_ID, 'Hitbtc', 'HitbtcExchange', $extraOptions );
  }
